...
public class Utils {
    ...
    /** True when the user should be sent to the in-app browser to retry. */
    public static boolean isBrowserRequiredError(String error) {
        if (error == null) return false;
        return error.startsWith(
                com.hassan.vidsavedownloader.services.DownloadService.CLOUDFLARE_ERROR_PREFIX);
    }
